...
class Test_TicTacToe(unittest.TestCase):
    ...
    # Alphabeta Vs Random
    # ------------------------------------------
    def test_aplhabeta_vs_random(self):
        wins, losses, draws, errors = self.versus(ALPHABETA, RANDOM, PLAYS)
    ...
    def test_random_vs_alphabeta(self):
        wins, losses, draws, errors = self.versus(RANDOM, ALPHABETA, PLAYS)
